...
**0:40 The request (tap 'Switzerland, sun-ready').** "Her calendar already knows she flies to Switzerland Monday for hiking. The agent surfaced the trip; she only adds her budget: $200, splurge on the face sunscreen, save on the body sunscreen." While it runs, narrate the activity card (its headline names the turn, and it lists only the steps this turn really runs: a follow-up like "swap the body sunscreen for something cheaper" shows just *Shopping the web* and *Balancing your budget*, because her ring, calendar and profile are carried over rather than re-read):
- *Remembering you* — "Cognee recall, injected before the model speaks. She never repeats herself."
...
**1:40 The result.** Point at the face sunscreen card (the splurge) and the body sunscreen card (the save). "Every claim carries its source. *Brain*: she lives in humid Taiwan and wants light textures, PDRN, functional K-beauty, no fragrance. *Ring*: 4.5 hours of sleep, so hydrating formulas, nothing stripping. *Calendar*: she flies Monday, so Prime delivery by Sunday. *Live web*: Amazon's price, stock and the ingredient list, checked minutes ago: non-nano zinc, no oxybenzone." Then the excluded list: "It threw out the two SPF tints on her own shelf, because tinted makeup is not a sunscreen for a mountain hike. That is the profile and the calendar reasoning together."

**2:10 The action.** Tap Review → Approve. "Nothing is purchased without a tap: a Strands hook cancels the purchase tool unless this turn was approved." Show "Your plan is ready" with the Buy link and the "On your calendar" row: tap it (or refresh the laptop's Google Calendar tab; the phone opens whichever Google account it is signed into). "The reminder is on her calendar before she flies." Then the "I'll remember that" pill: "The purchase is now in her brain."
...
- Ring not connected: the agent says so in one clause and continues. Calendar event missing after Approve: type "Please add a reminder to my calendar for Sunday 27 September at 6 PM to pack the sunscreen" and tap Review → Approve again. `?replay=1` replays the cached basket and, on Approve, the cached calendar link.
